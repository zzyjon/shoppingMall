...
<body class="animsition">
	...
	<div class="container">
		...
		<form class="form-horizontal" action="/user/page/member/memberRegist"
			method="post" id="register" data-bv-message="This value is not valid"
			...
			<fieldset>
					...
					<div class="col-md-4 inputGroupContainer">
						<div class="input-group">
							<span class="input-group-addon"><i
								...
								placeholder="닉네임을 입력해주세요" class="form-control" type="text"
								required data-bv-notempty-message="닉네임을 입력해주세요."
								pattern="^[가-힣a-z0-9]+$"
					...
					<div class="col-md-4 inputGroupContainer">
						<div class="input-group">
							<span class="input-group-addon"><i
								...
								id="mPost" placeholder="우편번호를 입력해주세요" class="form-control"
								type="text">
						</div>
					</div>
				...
				<div class="form-group">
					...
					<div class="col-md-4 inputGroupContainer">
						<div class="input-group">
							<span class="input-group-addon"><i
								class="glyphicon glyphicon-home"></i></span> <input id="mMainAddress"
								name="mMainAddress" placeholder="기본주소를 입력해주세요"
				...
				<div class="form-group">
					...
					<div class="col-md-4 inputGroupContainer">
						<div class="input-group">
							<span class="input-group-addon"><i
								class="glyphicon glyphicon-home"></i></span> <input id="mSubAddress"
								name="mSubAddress" placeholder="상세주소를 입력해주세요"
								class="form-control" type="text">
						</div>
					</div>
				</div>
